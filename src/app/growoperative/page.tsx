...
export default function GrowOperativePage() {
  return (
    <div className="px-6 max-w-3xl mx-auto text-foreground">
      ...
      <Section>
        <h2 className="text-2xl font-semibold mb-2">What Is GrowOperative?</h2>
        <p>
      ...
      <Section>
        <h2 className="text-2xl font-semibold mb-4">How GrowOperative Works</h2>
        <div className="space-y-8">
          <div>
            <h3 className="font-bold">1. List What You’re Offering</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">2. Your Listing Travels Through the Network</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">3. Transactions Are Logged as Credit</h3>
            <p>
          ...
          <div>
            <h3 className="font-bold">4. You Decide How to Settle It</h3>
            <p>
              You and the other person agree on how and when to settle the credit. It could be cash,
              something they offer later, or any form of value you both accept. The app doesn't handle payment or
              enforce terms. It simply records the agreement.
            </p>
          </div>
          <div>
            <h3 className="font-bold">5. A Community Marketplace Built on Trust</h3>
            <p>
              GrowOperative is a marketplace, but one where relationships and accountability matter more than
              speed or volume. It helps communities keep value flowing, even when money is scarce.
            </p>
          </div>
        </div>
      </Section>
      ...
      <Section>
        <h2 className="text-2xl font-semibold mb-2">Example Use Case</h2>
        <p>
      ...
      <Section>
        <h2 className="text-2xl font-semibold mb-2">RHEO Access and Network Borrowing</h2>
        <p>
      ...
      <Section>
        <h2 className="text-2xl font-semibold mb-2">How It Is Different</h2>
        <ul className="list-disc list-inside space-y-2">
